...
GO_LDFLAGS += -X github.com/sapcc/kube-fip-controller/pkg/version.Branch=$(GIT_BRANCH) -X github.com/sapcc/kube-fip-controller/pkg/version.BuildDate=$(BUILD_DATE) -X github.com/sapcc/kube-fip-controller/pkg/version.Revision=$(GIT_REVISION) -X github.com/sapcc/kube-fip-controller/pkg/version.Version=$(VERSION)
GO_TESTFLAGS +=
GO_TESTENV +=
GO_BUILDENV +=

build-all: build/kube-fip-controller

build/kube-fip-controller: FORCE
	env $(GO_BUILDENV) go build $(GO_BUILDFLAGS) -ldflags '-s -w $(GO_LDFLAGS)' -o build/kube-fip-controller ./cmd
...
install: FORCE build/kube-fip-controller
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/kube-fip-controller "$(DESTDIR)$(PREFIX)/bin/kube-fip-controller"
...
goimports: FORCE install-goimports
	@printf "\e[1;36m>> goimports -w -local https://github.com/sapcc/kube-fip-controller\e[0m\n"
	@goimports -w -local github.com/sapcc/kube-fip-controller $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
...
help: FORCE
	...
	@printf "  \e[36mbuild/kube-fip-controller\e[0m    Build kube-fip-controller.\n"
